...
import { FacebookIcon, LinkedInIcon, MoonIcon, SunIcon, TwitterIcon } from "./Icons";
...
const CustomLink = ({href, title, className=""}) => {
    ...
    return(
        <Link href={href} className={`${className} relative group`}>
            ...
            group-hover:w-full transition-[width] ease duratio-300
    ...
    return(
        ...
        className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
            ...
            <nav className="flex items-center justify-center flex-wrap">
                <motion.a href="https://twitter.com/muffinsku11" target={"_blank"}
                    whileHover={{y:-2}}
                    whileTap={{scale:0.9}}
                    className="w-6 mr-3"
                >
                    <TwitterIcon /></motion.a>
                <motion.a href="https://www.linkedin.com/in/darshan-panchasara/" target={"_blank"}
                    whileHover={{y:-2}}
                    whileTap={{scale:0.9}}
                    className="w-6 ml-3"
               ...
               className={`ml-5 flex items-center justify-center rounded-full p-1 ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}`}
               >
                {
                    mode === "dark" ?
...

          {
            ...
            <nav className="flex items-center flex-col justify-center">
                ...
                <CustomMobileLink href="/about" title="About" c toggle={handleClick} />
